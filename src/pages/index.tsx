...
export default function Registration() {
  ...
  const handleLoginRedirect = () => {
    router.push("/login");  // เมื่อคลิกปุ่ม Login จะเปลี่ยนหน้าไปยังหน้า login
  };
  const handleSubmit = () => {
    ...
    // Template form submit action: For now, just logging the form data
          ...
          <div>
            ...
            <div className="loginButton d-flex gx-2 justify-content-center">
              ...
              />
               <Button
                type={`button`}
                className={`bg-secondary text-light cursor m10-top col-6 mx-2`}
                text={`Login`}
